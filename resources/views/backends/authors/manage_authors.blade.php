            ...
            <div class="content-header row">
                <div class="content-header-left col-md-9 col-12 mb-2">
                    <div class="row breadcrumbs-top">
                        <div class="col-12">
                            <h2 class="content-header-title float-left mb-0">AUTHORS</h2>
                            ...
                            <div class="card-content">
                                <div class="item-img text-center">
                                    <a href="#" class="view-authors" data-id='{{ $row->atr_id }}'>
                                        <img src="{{ asset('/storage/app/authors-photo/'.$row->atr_photo) }}" class="img-fluid" alt="img-placeholder">
                                    </a>
                                </div>
                                <div class="card-body">
                                    ...
                                    <div class="item-name">
                                        <a href="#" class="view-authors" data-id='{{ $row->atr_id }}'>
                                            {{ $row->atr_name .' '. $row->atr_last_name }} 
                                        </a>
                                    </div>
                                    <div>
                                ...
                                <div class="item-options text-center">
                                    <div class="cart view-authors" title="View Details" data-id='{{ $row->atr_id }}'>
                                        <i class="feather icon-eye"></i>
                                    </div>
                                    <div class="wishlist edit-authors" data-id='{{ $row->atr_id }}'>
                                        <i class="feather icon-edit"></i> Edit
                                    </div>
                                    <div class="wishlist remove-authors" data-id='{{ $row->atr_id }}'>
...
@section('script')
 ...
 <script type="text/javascript">
    ...
    $('#addNew').click(function(){
        ...
        openDiv();
        $.get('{{route('new_author')}}',function (data){
            $(body).html(data);
        })
    });
    ...
    $('.edit-authors').on("click", function () {
        ...
        openDiv();
        $.get('{{route('edit_author')}}/'+id,function (data){
            $(body).html(data);
        })
    });
