        ...
        <div class="col-md-12 col-12">
            <div class="card" style="height: 100%;">
                <div class="card-content">
                    <div class="card-body">
                        <form class="form" method="post" action=" {{ route('insert-user')}}" enctype="multipart/form-data">
                            {{ csrf_field() }}
                            <div class="form-body">
                                <div class="row">
                                    <div class="col-6">
                                    ...
                                    <div class="col-6">
                                        <div class="form-label-group position-relative has-icon-left">
                                            <input type="password" required="" id="contact-floating-icon" class="form-control" name="password" placeholder="Password ... ">
                                            <div class="form-control-position">
                                    ...
                                    <div class="col-6">
                                        <div class="form-label-group position-relative has-icon-left">
                                            <input type="password" required="" id="contact-floating-icon" class="form-control" name="confirm_password" placeholder="confirm password">
                                            <div class="form-control-position">
                                                <i class="feather icon-smartphone"></i>
                                            </div>
