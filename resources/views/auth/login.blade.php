...
<head>
    ...
    <title>Login Page - BOUM BOOKS</title>
                        ...
                        <div class="card bg-authentication rounded-0 mb-0">
                            <div class="row m-0">
                                <div class="col-lg-6 d-lg-block d-none text-center align-self-center px-1 py-0">
                                    <img src="{{ asset('public/assets/backends') }}/app-assets/images/pages/login.png" alt="branding logo">
                                </div>
                                            ...
                                            <div class="card-body pt-1">
                                                <form action="{{ route('login') }}" method="POST">
                                                    ...
                                                    <fieldset class="form-label-group form-group position-relative has-icon-left">
                                                        <input type="email" class="form-control" name="u_email" value="{{ old('u_email') }}" id="user-name" placeholder="Username" required>
                                                        <div class="form-control-position">
                                                            <i class="feather icon-user" style="top: 4px;"></i>
                                                        </div>
                                                    ...
                                                    <fieldset class="form-label-group position-relative has-icon-left">
                                                        ...
                                                        <div class="form-control-position">
                                                            <i class="feather icon-lock" style="top: 4px;"></i>
                                                        </div>
